...
public class STAYSTILL : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.SetPositionAndRotation(new Vector3(playerTransform.position.x, playerTransform.position.y + YfixedPlacement, playerTransform.position.z + ZfixedPlacement), Quaternion.Euler(0, 0, fixedRotation));
    }
